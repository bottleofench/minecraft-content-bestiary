...
| [Citizens2](https://citizensnpcs.co) | Доп. возможности | Плагин, позволяющий создавать различных NPC самых разных видов, а также ими управлять. | 1.8+ |
| [Debuggery](https://github.com/zachbr/Debuggery) | Утилита | Плагин, позволяющий выполнять отладку различных функций в ядрах серверов, как с целью нахождения неисправностей, так и для веселья. | 1.13+ |
...
| [ImageOnMap](https://www.spigotmc.org/resources/imageonmap.26585/) | Доп. возможности | Плагин, позволяющий вставить в игру любую картинку с помощью самых обычных карт. | 1.17+ |
...
| [ServerListPlus](https://www.spigotmc.org/resources/serverlistplus.241/) | Доп. возможности | Плагин, позволяющий вам сделать красивое, анимированное название сервера в списке игровых серверов (MOTD). | 1.7+ |
| [SMP Spectator Mode](https://www.spigotmc.org/resources/smp-spectator-mode-1-18-support.77267/) | Доп. возможности | Плагин, позволяющий использовать режим наблюдателя даже обычным игрокам с целью просмотра построек и т.д. | 1.17+ |
| [SurvivalInvisiframes](https://www.spigotmc.org/resources/survivalinvisiframes.80692/) | Доп. возможности | Плагин, позволяющий вам создавать невидимые рамки. | 1.16+ |
...
| [ViaVersion](https://www.spigotmc.org/resources/viaversion.19254/)| Доп. возможности | Плагин, позволяющий заходить на сервер с самых различных версий игры. | 1.8+ |	
| [WorldEdit](https://dev.bukkit.org/projects/worldedit) | Управление миром | Классика. | 1.7.2+ |
| [WorldsColor](https://www.spigotmc.org/resources/worldscolor-colored-nicknames-in-various-worlds.94335/) | Утилита | Плагин, перекрасывающий ники игроков в цвета измерений, в которых они находятся. Может не работать не с которыми плагинами на чат. | 1.12 - 1.17.1 |